...
public class DrivingSimulationLab {
    ...
    public static void changeGear() {
        ...
        System.out.print("Enter desired gear (P for Park, D for Drive, R for Reverse): ");
        ...
        if (newGear.equals("P") || newGear.equals("D") || newGear.equals("R")) {
            // Update the gear based on the user's input
            gear = newGear;
            System.out.println("Gear changed to: " + gear);
        } else {
            // Display an error message if the input is invalid
            System.out.println("Invalid gear choice. Please enter P, D, or R.");
        }
    }
    ...
    public static void accelerate() {
        ...
        if (isEngineOn && !gear.equals("P")) {
            ...
            if (!isEngineOn) {
                System.out.println("Error: The engine is off. Please start the engine first.");
            } else if (gear.equals("P")) {
                System.out.println("Error: The car is in Park. Please change the gear to Drive or Reverse to accelerate.");
            }
        }
    }
    ...
    public static void brake() {
        ...
        if (isEngineOn && speed > 5) {
            ...
            if (!isEngineOn) {
                ...
                System.out.println("Error: The speed is too low to apply the brake.");
            }
        }
    }
    ...
    public static void exitSimulation() {
        ...
        System.out.println("Thank you for using the driving simulation. Exiting the program...");
